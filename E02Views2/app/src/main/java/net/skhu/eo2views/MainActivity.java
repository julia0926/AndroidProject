...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        else if (id == R.id.action_spinner2) {
            Intent intent = new Intent(this, SpinnerActivity2.class);
            startActivity(intent);
            return true;
        }
        else if (id == R.id.action_alert2) {
            Intent intent = new Intent(this, AlertsAcitivity2.class);
            startActivity(intent);
            return true;
        }
